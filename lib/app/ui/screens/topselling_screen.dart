...
import 'package:template/app/ui/widgets/dashboard/topselling_bigtile.dart';
import 'package:template/app/ui/widgets/dashboard/topselling_tile.dart';

import '../widgets/dashboard/search_bar.dart';

class TopSellingScreen extends StatelessWidget {
  const TopSellingScreen({Key? key}) : super(key: key);
                ...
                SizedBox(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      return TopSellingBigTile(onTap: () {});
                    },
                  ),
                ),
              ],
